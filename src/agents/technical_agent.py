"""
Technical Agent - Handles technical queries using a RAG approach
"""
...
class TechnicalDocument(BaseModel):
    """Schema for a technical document retrieved from the knowledge base"""
...
class TechnicalAgent:
    """
    Agent responsible for handling technical queries using RAG.
    """
    
    def __init__(self):
        """Initialize the technical agent with its knowledge base."""
        # Load FAISS index
    ...
    async def process_query(self, query: str) -> Dict[str, Any]:
        """
        Process a technical query using RAG.
        ...
        """
        logger.info(f"Processing technical query: {query}")
